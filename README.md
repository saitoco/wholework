...
3. **Agentic execution** — `/auto` runs the full workflow unattended — hand off a single issue or your whole backlog and let it orchestrate every phase for as long as the work takes.
