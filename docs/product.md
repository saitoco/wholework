...
| Autonomy tier | An `autonomy:` field (`L1` / `L2` / `L3`) declaring how far skills may write L0 GitHub state and fire L2→L1 paths. SSoT: `modules/autonomy-tier.md`. Orthogonal to `permission-mode` | Skill development, configuration | Autonomy tier |
