...
- #890
- #891 (found in a follow-up pass: `source emit-event.sh` parse error under zsh in SKILL.md-embedded bash snippets)
- #892 (found in a follow-up pass: AUTO_SESSION_ID pointer-file re-derivation requirement undocumented)
