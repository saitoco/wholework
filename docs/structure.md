...
│           data-layer.md    # Data-layer report (generated by /audit auto-session)
│           data-layer-ja.md # Japanese translation sibling
│         _daily/        # Daily auto-generated files
│           auto-events-rollup-{DATE}.md # Daily rollup (generated by scripts/auto-events-rollup.sh)
│           loop-state-{DATE}.md         # Loop state heartbeat log (generated by /auto Loop State Heartbeat)
...
**Project utilities:**
- `scripts/auto-events-rollup.sh` — roll up `.tmp/auto-events.jsonl` into a curated daily report under `docs/sessions/_daily/auto-events-rollup-YYYY-MM-DD.md`; accepts `--date`, `--input`, `--output-dir`, `--cleanup`
