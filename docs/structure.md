...
│           session.md       # L3 narrative (What worked / Limits and gaps / Improvement candidates) plus a machine-generated `## Metrics` section (via get-auto-session-report.sh --metrics-only)
