...
│   ├── guide/           # User-facing manual (index, quick-start, workflow, customization, troubleshooting, adapter-guide, figma-best-practices, scripting, xl-decomposition) (project)
