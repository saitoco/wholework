...
| `skills/issue/mcp-call-guidelines.md` | `/issue` | Always read; internally branches on `MCP_TOOLS` / ToolSearch | _(none — runtime-detected)_ | MCP tool detection |
