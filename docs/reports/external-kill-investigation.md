...
> **Note (#1214)**: the `next_cycle_seeded` event referenced above was removed in #1214. For batch-session identification going forward, use the `"mode": "batch"` field in `.tmp/auto-session-<AUTO_SESSION_ID>.json` instead.
