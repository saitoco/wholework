---
type: report
description: Archive for docs/reports/orchestration-recoveries.md entries rotated out once the live file exceeds its line-count trigger. Newest-archived-first. Not consumed by scripts/collect-recovery-candidates.sh or any other runtime script.
---

# Orchestration Recoveries Archive

This file archives entries removed from `docs/reports/orchestration-recoveries.md` once the live file exceeds its rotation trigger, preserving them as historical incident records while keeping the live file's per-`/verify`-run read cost bounded.

## Role

- **Scope**: cross-Issue, persistent archive — not a per-Issue Spec artifact
- **Role**: preserve the full `### Context` / `### Diagnosis` / `### Recovery Applied` / `### Outcome` / `### Improvement Candidate` structure of rotated-out entries, so the incident record is not lost when the live copy is trimmed
- **Not consumed by**: `scripts/collect-recovery-candidates.sh` or any other runtime script — this file is documentation only, not part of the frequency-grouping input
...
## 2026-07-31 03:08 UTC: manual-recovery-review-rerun
...
### Diagnosis
- Parent session recovered the phase outside the Tier 1/2/3 machinery (recovery type: review-rerun)
...
## 2026-07-29 07:26 UTC: manual-recovery-review-rerun
...
## 2026-07-29 06:35 UTC: manual-recovery-push-and-pr

### Context
- Issue #1066, phase: code-pr
- Source: parent-session-manual-recovery
- Wrapper: run-auto-sub.sh, exit code: unknown

### Diagnosis
- Parent session recovered the phase outside the Tier 1/2/3 machinery (recovery type: push-and-pr)
...
## 2026-07-29 06:01 UTC: manual-recovery-review-rerun
...
## 2026-07-29 05:01 UTC: manual-recovery-respawn
...
## 2026-07-29 03:02 UTC: manual-recovery-completion-override
...
### Diagnosis
- Parent session recovered the phase outside the Tier 1/2/3 machinery (recovery type: completion-override)
...
## 2026-07-29 02:57 UTC: manual-recovery-respawn
...
## 2026-07-23 14:14 UTC: manual-recovery-push-and-pr

### Context
- Issue #1045, phase: code-pr
- Source: parent-session-manual-recovery
- Wrapper: run-auto-sub.sh, exit code: unknown
...
## 2026-07-23 13:44 UTC: manual-recovery-respawn
...
## 2026-07-23 12:44 UTC: manual-recovery-respawn
...
## 2026-07-23 02:44 UTC: manual-recovery-respawn-skip-code
...
### Diagnosis
- Parent session recovered the phase outside the Tier 1/2/3 machinery (recovery type: respawn-skip-code)
...
## 2026-07-22 16:19 UTC: manual-recovery-respawn-skip-code
...
## 2026-07-20 07:17 UTC: manual-recovery-respawn

### Context
- Issue #1023, phase: code-patch
- Source: parent-session-manual-recovery
- Wrapper: run-auto-sub.sh, exit code: unknown
...
## 2026-07-16 04:12 UTC: manual-recovery-respawn
...
## 2026-07-15 10:06 UTC: manual-recovery-respawn

### Context
- Issue #994, phase: issue
- Source: parent-session-manual-recovery
- Wrapper: run-auto-sub.sh, exit code: unknown
...
## 2026-07-15 07:23 UTC: manual-recovery-respawn
...
### Diagnosis
- Parent session recovered the phase outside the Tier 1/2/3 machinery (recovery type: skip-forward)
...
## 2026-07-13 17:00 UTC: manual-recovery-respawn
