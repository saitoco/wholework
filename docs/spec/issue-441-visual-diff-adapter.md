...
- Issue body の Pre-merge AC は当初 12 items だったが Spec を SSoT として 10 items に整理 (V2/V5/V7 で複数 verify hint を 1 item に集約)。Spec Simplicity Rules (full: 10 items) との整合と count alignment check の両方を満たす
