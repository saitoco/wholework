...
| New script references in allowed-tools | When a SKILL.md body adds a new `${CLAUDE_PLUGIN_ROOT}/scripts/` reference, include `allowed-tools` frontmatter update in Spec's changed-files list | #445 |
